...
1. **Isolated Packages**: All GitHub Actions REST APIs, live telemetry clients, and worker models live in:
   - `qBitController/composeApp/src/commonMain/kotlin/dev/bartuzen/qbitcontroller/model/github/`
   - `qBitController/composeApp/src/commonMain/kotlin/dev/bartuzen/qbitcontroller/network/github/`
   - `qBitController/composeApp/src/commonMain/kotlin/dev/bartuzen/qbitcontroller/data/repositories/github/`
