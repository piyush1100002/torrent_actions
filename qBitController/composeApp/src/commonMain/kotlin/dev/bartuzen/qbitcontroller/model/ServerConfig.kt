...
data class ServerConfig(
    ...
    val isGitHubActionsServer: Boolean
        get() = gitHubConfig != null && gitHubConfig.isValid
    ...
    val visibleUrl = if (isGitHubActionsServer) gitHubConfig?.displayRepo ?: "" else url.replace(protocolRegex, "")

    val displayName = name ?: if (isGitHubActionsServer) "⚡ GitHub: ${gitHubConfig?.displayRepo}" else visibleUrl
