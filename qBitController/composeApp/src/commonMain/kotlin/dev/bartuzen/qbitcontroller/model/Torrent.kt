...
data class Torrent(
    ...
    @SerialName("worker_run_id")
    val workerRunId: Long? = null,

    @SerialName("worker_tunnel_url")
    val workerTunnelUrl: String? = null,

    @SerialName("worker_password")
    val workerPassword: String? = null,

    @SerialName("worker_stage")
